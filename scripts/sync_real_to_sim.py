"""Synchronize real UR3e joint states into the canonical Isaac scene, read-only."""
...
from vla_sim.joint_sync import LatestJointState, ROSJointStateSubscriber
from vla_sim.runtime import JointSyncBackend, RuntimeOptions, SimulationRuntime
        ...
        while app.is_running():
            ...
            if state != "paused":
                ...
                if next_state != state:
                    ...
                    bridge.update_status(joint_sync=snapshot)
            else:
                bridge.update_status(joint_sync=snapshot)
